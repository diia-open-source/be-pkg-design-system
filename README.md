...
This repository contains the package with shared node.js design system protobuf components.
...
```
git clone https://github.com/diia-open-source/be-pkg-design-system.git pkg-design-system
```
...
In order to install and use the linked dependencies for `pkg-design-system` the following command can be used:
